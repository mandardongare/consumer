...
public class CustomerAddress {
   ...
   * @return addressLine1
   **/
  @ApiModelProperty(example = "F-103, 8 KOOL HOMES", required = true, value = "Address Line 1")
  @NotNull(message = "The field addressLine1 is required")

  @Pattern(regexp = "^[A-Za-z0-9- ]+{50}$",
      message = "The field addressLine1 is invalid. The field addressLine1 must be alphanumeric with max length of 50")
   ...
   * @return addressLine2
   **/
  @ApiModelProperty(example = "Near Green Valley", value = "Address Line 2")
  @Pattern(regexp = "^[A-Za-z0-9- ]+{50}$",
      message = "The field addressLine2 is invalid. The field addressLine2 must be alphanumeric with max length of 50")
   ...
   * @return street
   **/
  @ApiModelProperty(example = "10 Main St",
      value = "Street name of the customer's business address")

  @Pattern(regexp = "^[A-Za-z0-9- ]+{10}$",
      message = "The field street is invalid. The field street must be alphanumeric with max length of 50")
   ...
   * @return postalCode
   **/
  @ApiModelProperty(example = "410206", required = true,
      value = "Postal code of the customer's business address")
  @NotNull(message = "The field postalCode is required")
  @Pattern(regexp = "^[0-9]{6}$",
      message = "The field postalCode is invalid. The field postalCode must be numeric with max length of 6")
